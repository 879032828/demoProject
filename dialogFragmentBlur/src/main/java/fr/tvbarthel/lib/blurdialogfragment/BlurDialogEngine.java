...
public class BlurDialogEngine {
     ...
     */
    private RoundedImageView mBlurredBackgroundView;
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        final int topOffset = actionBarHeight + statusBarHeight + 200;
        ...
        mBlurredBackgroundView = new RoundedImageView(mHoldingActivity);
        mBlurredBackgroundView.setCornerRadius(100);
    ...
    private class BlurAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            mBlurredBackgroundLayoutParams.setMargins(0, 500, 0, 0);
