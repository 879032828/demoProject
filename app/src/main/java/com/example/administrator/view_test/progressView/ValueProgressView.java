 ...
 */
public class ValueProgressView extends View {
    float progress = 0;
    float radius = 30;
    long duration = 1000;
    ...
    public ValueProgressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    ...
    public ValueProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
